...
class StandardPlotter:
    """
    Creator of standard scientific plots.
    ...
    def change_ax_defaults(self, reset: bool = False, **kwargs):
        ...
        reset: bool. Default=False
            ...
            to the default.
        **kwargs of the defaults you want to change. The options are
            StandardPlot.ax_pref.keys()

        Return
        ======
        (dict) new set of defaults.
    ...
    def axis_setter(self, ax: Union[plt.Axes, int] = 0,
        ...
        reset: Default=False
            True to change the value of the other options for the default
            values.
        general_pars: Default={}
            general parameters to change with
            StandardPlotter.change_general_pars.
    ...
    def raxis(self,
        ...
        lax_color: RGB array or matplotlib colors. Default=[0.4, 0.4, 0.4]
    ...
    def set_polar(self,
        ...
        r_ticks: array. Default=None (<automatic>)
            ...
            numbers.
        r_lims: list. Default=None
            minimum or maximum value of the data. Defaults as predicted by
            matplotlib.
        add_center: float. Default=0
            shift the minimum value of r limits to this radius.
        add_border: float. Default=0
        ...
        Note
        ====
        add_center and add_border value only makes sense when r_lim is defined.
        """
        index = None
        if isinstance(ax, int):
            index = ax
