...
pymodules = {
    ...
    'create_table_per_system': 'myutils.g_values.analysis..ipynb_checkpoints.postpro-checkpoint',
    'create_table_per_method': 'myutils.g_values.analysis..ipynb_checkpoints.postpro-checkpoint',
    'extract_gvals': 'myutils.g_values.analysis..ipynb_checkpoints.postpro-checkpoint',
...
other_files = {
    ...
    'create_mol_png-checkpoint': './g_values/analysis/.ipynb_checkpoints/create_mol_png-checkpoint.tcl',
